    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card" style="margin-top: 5%;">
                <div class="card-header bg-secondary text-white">{{ __('Organization Registration') }}</div>

                <div class="card-body">
                    <form method="POST" action="/register_organisation">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input id="organisation_name" type="text" class="form-control @error('organisation_name') is-invalid @enderror" name="organisation_name" value="{{ old('organisation_name') }}" required autocomplete="organisation_name" autofocus>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label for="organisation_regnum" class="col-md-4 col-form-label text-md-right">{{ __('Org reg number') }}</label>

                                <input id="organisation_regnum" type="text" class="form-control @error('organisation_regnum') is-invalid @enderror" name="organisation_regnum" value="{{ old('organisation_regnum') }}" required autocomplete="organisation_regnum" autofocus>

                                @error('organisation_regnum')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="row">
							...
							<div class="col-md-6">
                                <div class="form-group">
                                    <label for="representative_country">Country</label>
                                    <div class="form-control">
                                    <select  class="dropdown-item" id="representative_country" name="representative_country">
                                        <option value="" selected>Select country</option>
                                        <option value="Malawi">Malawi</option>
                                        <option value="Kenya">Kenya</option>
                                        <option value="Tanzania">Tanzania</option>
                                 ...
                                 <span class="text-danger">@error('representative_country'){{ $message }}@enderror</span>    
                                </div>
								{{-- <label for="representative_country" class="col-md-6 col-form-label text-md-right">{{ __('Country') }}</label>

								<input id="representative_country" type="text" placeholder="Enter Country" class="form-control" name="representative_country" value="{{ old('representative_country') }}"> --}}
